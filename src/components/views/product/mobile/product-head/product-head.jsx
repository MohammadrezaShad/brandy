...
const ProductHead = ({ currentProductAnchor, setCurrentProductAnchor }) => {
  const { query } = useRouter();
  const [isProductHeadShow, setIsProductHeadShow] = useState(false);
    ...
    <S.Wrap isProductHeadShow={isProductHeadShow}>
      ...
      <S.BottomConent>
        <S.Item selected={currentProductAnchor === ProductAnchors.PRODUCT_CAROUSEL}>
          <Link href={`${Paths.product.detail(query.id).getPath()}#${ProductAnchors.PRODUCT_CAROUSEL}`}>
            <S.Anchor
              onClick={() => {
        ...
        <S.Item selected={currentProductAnchor === ProductAnchors.REVIEWS}>
          <Link href={`${Paths.product.detail(query.id).getPath()}#${ProductAnchors.REVIEWS}`}>
            <S.Anchor
              onClick={() => {
        ...
        <S.Item selected={currentProductAnchor === ProductAnchors.COLLECTION}>
          <Link href={`${Paths.product.detail(query.id).getPath()}#${ProductAnchors.COLLECTION}`}>
            <S.Anchor
              onClick={() => {
