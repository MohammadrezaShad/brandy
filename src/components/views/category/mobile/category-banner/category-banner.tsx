...
const CategoryBanner = () => {
  ...
  return (
    <S.Wrapper>
      ...
      <S.Text>
        <Typography variant={typographyVariant.BODY_SM_MEDIUM}>کفش کوهنوردی</Typography>
        <Typography variant={typographyVariant.INFO_XS_MEDIUM} color={typographyColor.ON_PRIMARY}>
          (0121)
        </Typography>
      </S.Text>
    </S.Wrapper>
